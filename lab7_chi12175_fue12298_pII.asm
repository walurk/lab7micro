...
;uvg
;LAB 7 PARTE 2:
;PARA QUE UN CANAL CONTROLA UN RC, Y OTRO CONAL CONTROLA OTRO RC
...
INIT:
    ...
    BCF INTCON, GIE         ;APAGO TODAS LAS INTERRUPCIONES
...
;**********************************************************************************
    ...
    ;YA  NO LO HAGO, TODO SE MANJERA EN MAIN, Y SIN INTERRUPCIONES
    ...
    ;CONFIGURARA ANS12=RB0 PARA ENTRADA ANALOGICA
    BANKSEL ANSELH
    BSF ANSELH, 4           ;COMO ENTRADA ANALOGICA
    BANKSEL TRISB
...
MAIN:
    ...
    BSF ADCON0, 4
    BCF ADCON0, 3
    BCF ADCON0, 2           ;CAMBIO A ANS4, RA5

    BSF ADCON0, 1           ;HABILITAMOS ADC
    BSF ADCON0, 0           ;ENDENDEMOS ADC

    BTFSC ADCON0, 1         ;ESPERAR A QUE TERMINE CONVERSION
    GOTO $-1                ;REGRESO A INSTRUCCION ANTERIOR SI ES 1
 ...
 ;************************************************
    ...
    BSF ADCON0, 4
    BCF ADCON0, 3
    BCF ADCON0, 2           ;CAMBIO A ANS12, RB0
